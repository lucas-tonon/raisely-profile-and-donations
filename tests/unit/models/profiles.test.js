...
describe('Profiles Model', () => {
    ...
    describe('"getProfileById"', () => {
        test('should return profile with profileId value in "id" property', () => {
            // Given
    ...
    describe('"updateTotalForProfiles"', () => {
        ...
        test('should return number of updated records and correct their totals when they exist', () => {
            // Given
            const updateProfiles = [
                {
                    id: 'f249c0c1-048c-4c12-9789-f0ad8d4c243b',
    ...
    describe('"updateTotalForCampaignProfile"', () => {
        ...
        test('should return 1 if found campaign profile with given profile id', () => {
            // Given
            const newTotal = 1000;
